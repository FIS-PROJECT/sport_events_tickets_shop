...
public class FootballController implements Initializable {
    ...
    @FXML
    private TableView<com.example.sporteventsticketsshop.entities.Event> table;
    @FXML
    private TableColumn<com.example.sporteventsticketsshop.entities.Event,String> name;
    @FXML
    private TableColumn<com.example.sporteventsticketsshop.entities.Event, String> date;
    @FXML
    private TableColumn<com.example.sporteventsticketsshop.entities.Event,Integer> seats;
    @FXML
    ...
    ObservableList<Event> list = FXCollections.observableList(db.readEvents().stream().filter(event -> event.getSportType().equals(SportType.FOOTBALL)).collect(Collectors.toList()));
    @Override
    public void initialize(URL url, ResourceBundle resourceBundle){
        ...
        seats.setCellValueFactory(new PropertyValueFactory<com.example.sporteventsticketsshop.entities.Event,Integer>("numberOfSeats"));
